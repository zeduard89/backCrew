...
UserModel_1.default.hasMany(ProjectModel_1.default, { foreignKey: "creatorId" });
ProjectModel_1.default.belongsTo(UserModel_1.default, { foreignKey: "creatorId", targetKey: "id" });
