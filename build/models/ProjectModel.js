...
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => db_1.UserModel),
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.STRING,
        allowNull: false
    })
...
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => db_1.UserModel, "creatorId") // Asigna un alias único a la asociación
], ProjectModel.prototype, "user", void 0);
