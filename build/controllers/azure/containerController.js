...
const createContainer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (containerExist)
            throw new Error(`El container: ${container} ya existe`);
        ...
        const errorMessage = error.message || "Error desconocido al crear un container";
...
const deleteContainer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const containerExist = yield containerClient.exists();
        if (!containerExist)
            throw new Error(`El container: ${container} no existe`);
        blobService.deleteContainer(container);
        res.json({ message: `El container: ${container} fue eliminado con exito` });
    }
    catch (error) {
        const errorMessage = error.message || "Error desconocido al borrar un container";
        res.status(500).send(errorMessage);
    }
});
