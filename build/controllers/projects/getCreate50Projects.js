...
const getCreate50Projects = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const generatedProjects = [];
        for (let i = 0; i < 50; i++) {
            const createdProject = yield db_1.ProjectModel.create({
                ...
                category: categoriesExample[Math.floor(Math.random() * categoriesExample.length)],
                displayProject: true,
                // bank: "MercadoLibre",
        ...
        const errorMessage = error.message || "Unknown error while saving Azure Image";
        return { errorMessage };
    }
});
exports.default = getCreate50Projects;
//# sourceMappingURL=getCreate50Projects.js.map