...
const createRandomProjectController = (auxNum) => {
    const categorias = [
        "Tech & Innovation",
        "Creative Works",
        "Community Projects"
    ...
    const createRandom = () => {
      ...
      Recuerda que esta es solo una descripción ficticia y puedes ajustarla o personalizarla según tus necesidades o contexto específico. ${Math.floor(Math.random() * 100)}`,
    ...
    for (let i = 0; i < numProyectos; i++) {
        ...
        db_1.ProjectModel.create(proyecto);
    }
};
